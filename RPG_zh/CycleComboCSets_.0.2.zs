...
void IceCombos(){
	...
	if ( lvl == 6 ) CycleCSets(CycleIceComboD,CycleIceCombos[TIMER_ICE_COMBO], itemdata it = game->LoadItemData(254); it->Level, CycleIceCombos, CSET_ICE_FIRST, CSET_ICE_LAST, 7);
}
