...
5. Import and compile the library. It requires std.zh, ffcscript.zh and stdCombos.zh
6. Assign WeaponLauncher item script to an empty slot.
...
LWEAPON_MISC_ITEMID - ID of item that launched this lweapon.
...
* value prior to calling this function so it can restore changed lweapon->damage value, if no collision
* with specific enemies occur.
* Run this every frame.
...
* or -1 for changing to net combo in the table.
