...
void TS_CheckandWarp(int linkdir, bool useffc){
	...
	if ( curmap >=0 && curmap <= 3 ) mapset = 0;
	if ( curmap >=4 && curmap <= 7 ) mapset = 5;
	if ( curmap >=32 && curmap <= 35 ) mapset = 9;
	if ( curmap >=71 && curmap <= 74 ) mapset = 13;
	if ( curmap >=75 && curmap <= 78 ) mapset = 17;
	if ( curmap >=79 && curmap <= 82 ) mapset = 21;
	if ( curmap >=83 && curmap <= 86 ) mapset = 25;
	if ( curmap >=87 && curmap <= 90 ) mapset = 29;
	if ( curmap >=91 && curmap <= 94 ) mapset = 33;
	if ( curmap >=95 && curmap <= 98 ) mapset = 37;
	if ( curmap >=101 && curmap <= 104 ) mapset = 41;
	if ( curmap >=105 && curmap <= 108 ) mapset = 45;
	if ( curmap >=109 && curmap <= 112 ) mapset = 49;
